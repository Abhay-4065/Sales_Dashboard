...
🛠️ Technologies Used ✔ Power BI / Tableau / Python (Matplotlib, Seaborn, Pandas) – For data visualization. ✔ SQL / Excel – For data cleaning and preprocessing.

📂 Files Included Dashboard Screenshot (sales_dashboard.png) – Visual representation of the dashboard.
...
🎯 How It Works Data Preprocessing: Cleans and structures the sales data.
